...
try:
    for n in echanges:
        ...
        print(f"Total volume of {currentPair} is {ticker['baseVolume']}. Breaking...")
...
with open('total_balance.txt', 'r+') as balance_file:
...
with open('usable_balance.txt', 'r+') as balance_file:
    balance_file.seek(0)
